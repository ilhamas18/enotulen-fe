...
const Page = () => {
  ...
  return (
    <div className="login-page-wrapper w-full">
      <div className="bg-white w-full min-h-screen w-full">
        <div className="flex md:flex-row flex-col">
          <div className="md:w-1/2 w-full bg-[#f5f7f9] flex flex-col w-full h-screen justify-center">
          ...
          <div className="md:w-1/2 w-full md:block hidden">
            <img src="/login-bg.png" className="h-screen w-full" alt="Background" />
          </div>
        </div>
      </div>
    </div>
