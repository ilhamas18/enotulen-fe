                    ...
                    <div className="cetak-wrapper bg-white dark:bg-meta-4 px-8" id="container" ref={printRef}>
                        <div className="header py-2 text-center border-b border-black">
                            <div className="flex flex-row gap-2 text-center justify-center relative h-auto">
                                <div className="w-[20%]">
                                    <img src="/logo/Lambang_Kota_Madiun.png" className="w-[110px] h-auto" />
                                </div>
                                <div className="title text-center flex-col space-y-[1px] w-[80%]">
                                    ...
                                    <div className="text-black dark:text-white font-bold text-title-ss">
                                        ...
                                        Jl  Mayjen Panjaitan  No. 17 Lt II, Kode Pos: 63137, Jawa Timur
                                    </div>
                                    <div className="text-black dark:text-white font-bold text-title-ss">
                                    ...
                                    <div className="text-black dark:text-white text-title-xsm mt-3 ml-4">
                                        ...
                                        <div className="flex flex-col space-y-1 mt-2">
                                            <div className="flex">
                                                ...
                                                <div className="title w-[75%]">{getDayOfWeek(laporan.tanggal[0]?.startDate)}</div>
                                            </div>
                                            <div className="flex">
                        ...
                        <div className="flex items-center justify-between px-4">
                            <div className="flex flex-col text-center">
                                ...
                                <div className="font-bold text-black dark:text-white text-title-ss mt-1">{laporan.atasan?.jabatan}</div>
                                <div className="font-bold text-black dark:text-white text-title-xsm mt-[120px] border-b border-black">{laporan.atasan?.nama}</div>
                                <div className="text-black dark:text-white text-title-xsm mt-1"> {laporan.atasan?.nama_pangkat} </div>
                            ...
                            <div className="flex flex-col text-center">
                                ...
                                <div className="text-black dark:text-white text-title-xsm mt-1">{laporan.pelapor?.nama_pangkat}</div>
